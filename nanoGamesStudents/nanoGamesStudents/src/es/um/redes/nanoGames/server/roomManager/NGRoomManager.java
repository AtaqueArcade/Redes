...
public abstract class NGRoomManager {
	...
	// the only requirement to add a player is that only MAX_PLAYERS are
	// accepted
	...
	// Check for a new challenge. We can make use of that checking in order to
	// build a new one if the conditions are satisfied
	...
	//Implementada para la descripción del juego
	public abstract String getdescriptionPlayers();
	...
	public abstract void setResultado();
	public abstract void endGame(NGPlayerInfo p);
}
